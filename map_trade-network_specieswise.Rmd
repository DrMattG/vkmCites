...
map_på = map_GBIF_locs(Species = "Python anchietae")
...
#ggsave("map_python_anchietae.pdf", map_på, width = 8, height = 8, units ="cm"  ) 
#ggsave("map_python_anchietae.tiff", map_på, width = 8, height = 8, units="cm", dpi=500, compression="lzw")
ggsave(filename="map_python_anchietae.png", device="png",  map_på, width = 19.05, height = 22.23, dpi = 300, units="cm")
